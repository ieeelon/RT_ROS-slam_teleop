...
def callback_manual(data):
    ...
    global xman
    xman = data.data
    print("DATA RECEIVED IS XMAN: ", xman)

def receive_manual():
    # rospy.init_node('snode_manual')
    rospy.init_node('teleop_twist_keyboard')
    rospy.Subscriber('pub_manual', Float32, callback_manual)
    rospy.wait_for_message('pub_manual', Float32)

def processing_manual(user_input):
    print("MODE SELECTED: ", user_input)
...
#        os.system("roslaunch final_assignment choice2.launch")
#
...
#         os.system("roslaunch final_assignment choice3.launch")
#     else:
